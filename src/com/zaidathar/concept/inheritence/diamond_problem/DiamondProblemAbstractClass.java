...
public abstract class DiamondProblemAbstractClass implements DiamondProblemInterface1, DiamondProblemInterface2{
    ...
    /**
     * If this abstract class is empty it will not give error to implement interface method
     * as we will be implementing those abstract methods in those classes who is extending this class.
     */
