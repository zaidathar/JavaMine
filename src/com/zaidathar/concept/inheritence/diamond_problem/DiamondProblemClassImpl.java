...
public class DiamondProblemClassImpl extends DiamondProblemAbstractClass implements DiamondProblemInterface1, DiamondProblemInterface2{
    /**
      ...
      No need to implement printMyName method as it already implemented in abstract class.
      If we implemented both interfaces in this class again we are getting error for implementing abstract method.
    ...
    public static void main(String[] args) {
        ...
        obj.printMyName(); // this implementation will come from abstract class.
    }
}
